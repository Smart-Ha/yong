 ...
 * 
 * 2018-05-12 新测试：
 * 1：PathUtil.class.getResource("/") 将获取 class path 根目录，例如：/Users/james/workspace/jfinal/webapp/WEB-INF/classes
 * 2：PathUtil.class.getResource("") 将获取 PathUtil 这个 class 所在的目录，即：rootClassPath + "/com/jfinal/kit"
 * 
 * 3：ClassLoader.getResource("/") 将获取到 null 值，该用法无意义
 * 4：ClassLoader.getResource("") 将获取 class path 根目录，与 PathUtil.class.getResource("/") 一样
 */
